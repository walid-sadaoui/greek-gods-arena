...
describe('Fights', () => {
  ...
  //       .send({ userId, characterName: currentUser.characters[0].name });
  ...
  //         characterName: currentUser.characters[0].name,
  //       });
  ...
  //       userId,
  //       currentUser.characters[0].name,
  //       { level: 5, attack: 8, defense: 20, magik: 2, health: 18 }
  //     );
